...
public class ReportUtills {
	 ...
	 * 
	 * @param table in which we will add cell. 
	 * @param font of the value. 
	 * @param border if true then no border. 
	 * @param colspan merge columns, 1 mean single column. 
	 * @param values to show columns, list of values, automatically adjust in table 
	 */
